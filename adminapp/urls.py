...
urlpatterns = [
    ...
    re_path(r"^categories/read/page/(?P<page>\d+)/$", adminapp.categories, name="page_category"),
    ...
    re_path(r"^products/read/category/(?P<pk>\d+)/page/(?P<page>\d+)/$", adminapp.products, name="page_product"),
